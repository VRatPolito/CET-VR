...
- [**Bézier Path Creator**](https://assetstore.unity.com/packages/tools/utilities/b-zier-path-creator-136082) (to be imported and patched[*](#known-issues))
...
1. **Missing Assets (Unity Asset Store deprecation)**: 
