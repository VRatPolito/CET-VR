...
public class AuthenticNose : MonoBehaviour
{
    ...
    [SerializeField]
    internal GameObject leftCameraObject;
    [SerializeField]
    internal GameObject rightCameraObject;
    ...
    void Start()
    {
        if(leftCameraObject != null)
        {
            ...
            leftEyeNoseModel.transform.parent = leftCameraObject.transform;
            leftEyeNoseModel.transform.localRotation = Quaternion.identity;
        }
        if (rightCameraObject != null)
        {
            rightCameraObject.SetActive(true);
            rightEyeNoseModel.transform.parent = rightCameraObject.transform;
            rightEyeNoseModel.transform.localRotation = Quaternion.identity;
        }
    }
