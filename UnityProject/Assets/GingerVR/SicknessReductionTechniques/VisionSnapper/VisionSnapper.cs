...
public class VisionSnapper : MonoBehaviour
{
    ...
    [SerializeField]
    TunnelingVignetteController controller;
    ...
    void Start()
    {
        ...
        controller.defaultParameters.featheringEffect = 0;
        controller.defaultParameters.apertureSize = 0;
        controller.defaultParameters.vignetteColor = new Color(0, 0, 0, 0);
    }
    ...
    IEnumerator SnapRoutine(){
        ...
        while(fadeOutProgress < fadeTime){
            ...
            controller.defaultParameters.vignetteColor = new Color(0, 0, 0, fadeOutProgress / fadeTime);
            yield return null;
        }
        controller.defaultParameters.vignetteColor = new Color(0, 0, 0, 1);
        ...
        while(fadeInProgress < fadeTime){
            ...
            controller.defaultParameters.vignetteColor = new Color(0, 0, 0, 1 - (fadeInProgress / fadeTime));
